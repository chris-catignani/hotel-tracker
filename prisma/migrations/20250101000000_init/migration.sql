...
-- CreateEnum
CREATE TYPE "Refundability" AS ENUM ('REFUNDABLE', 'NON_REFUNDABLE', 'UNKNOWN');
...
-- CreateTable
CREATE TABLE "price_watch_bookings" (
    "id" TEXT NOT NULL,
    "price_watch_id" TEXT NOT NULL,
    "booking_id" TEXT NOT NULL,
    "date_flexibility_days" INTEGER NOT NULL DEFAULT 0,
    "cash_threshold" DECIMAL(10,2),
    "award_threshold" INTEGER,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "price_watch_bookings_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "price_snapshots" (
    ...
    "check_in" DATE NOT NULL,
    "check_out" DATE NOT NULL,
    "lowest_refundable_cash_price" DECIMAL(10,2),
    "lowest_refundable_cash_currency" TEXT NOT NULL DEFAULT 'USD',
    "lowest_award_price" INTEGER,
...
-- CreateTable
CREATE TABLE "price_snapshot_rooms" (
    "id" TEXT NOT NULL,
    ...
    "award_price" INTEGER,
    "is_refundable" "Refundability" NOT NULL DEFAULT 'UNKNOWN',
    "is_corporate" BOOLEAN NOT NULL DEFAULT false,

    CONSTRAINT "price_snapshot_rooms_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "geo_cache_query_key_key" ON "geo_cache"("query_key");

-- CreateIndex
CREATE UNIQUE INDEX "properties_place_id_key" ON "properties"("place_id");

-- CreateIndex
CREATE UNIQUE INDEX "properties_name_hotel_chain_id_key" ON "properties"("name", "hotel_chain_id");

-- CreateIndex
CREATE UNIQUE INDEX "price_watches_user_id_property_id_key" ON "price_watches"("user_id", "property_id");

-- CreateIndex
CREATE UNIQUE INDEX "price_watch_bookings_booking_id_key" ON "price_watch_bookings"("booking_id");

-- CreateIndex
CREATE INDEX "price_snapshots_price_watch_id_fetched_at_idx" ON "price_snapshots"("price_watch_id", "fetched_at");

-- CreateIndex
CREATE INDEX "price_snapshot_rooms_price_snapshot_id_idx" ON "price_snapshot_rooms"("price_snapshot_id");
...
-- AddForeignKey
ALTER TABLE "properties" ADD CONSTRAINT "properties_hotel_chain_id_fkey" FOREIGN KEY ("hotel_chain_id") REFERENCES "hotel_chains"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "price_watches" ADD CONSTRAINT "price_watches_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "price_watch_bookings" ADD CONSTRAINT "price_watch_bookings_price_watch_id_fkey" FOREIGN KEY ("price_watch_id") REFERENCES "price_watches"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "price_watch_bookings" ADD CONSTRAINT "price_watch_bookings_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "price_snapshots" ADD CONSTRAINT "price_snapshots_price_watch_id_fkey" FOREIGN KEY ("price_watch_id") REFERENCES "price_watches"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "price_snapshot_rooms" ADD CONSTRAINT "price_snapshot_rooms_price_snapshot_id_fkey" FOREIGN KEY ("price_snapshot_id") REFERENCES "price_snapshots"("id") ON DELETE CASCADE ON UPDATE CASCADE;
