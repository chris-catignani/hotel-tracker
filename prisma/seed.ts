...
async function main() {
  ...
  await prisma.hotelChainSubBrand.createMany({
    data: [
      { hotelChainId: HOTEL_ID.HILTON, name: "Waldorf Astoria" },
      { hotelChainId: HOTEL_ID.HILTON, name: "LXR Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Conrad Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Canopy by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Signia by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Hilton Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Curio Collection by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "DoubleTree by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Tapestry Collection by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Embassy Suites by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Tempo by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Motto by Hilton" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Hilton Garden Inn" },
      { hotelChainId: HOTEL_ID.HILTON, name: "Hampton by Hilton" },
      ...
      { hotelChainId: HOTEL_ID.HILTON, name: "Homewood Suites by Hilton", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.HILTON, name: "Spark by Hilton", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.HILTON, name: "Hilton Grand Vacations" },
    ],
  });
  ...
  await prisma.hotelChainSubBrand.createMany({
    data: [
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "The Ritz-Carlton" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "St. Regis" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "JW Marriott" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "The Luxury Collection" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "W Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "EDITION" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Marriott Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Sheraton" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Westin" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Le Meridien" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Renaissance Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Autograph Collection Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Delta Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Gaylord Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Courtyard by Marriott" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Four Points by Sheraton" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "SpringHill Suites" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Fairfield by Marriott" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "AC Hotels by Marriott" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Aloft Hotels" },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Moxy Hotels" },
      ...
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Marriott Executive Apartments", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Apartments by Marriott Bonvoy", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Protea Hotels by Marriott", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "City Express by Marriott", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Four Points Flex by Sheraton", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "Four Points Express by Sheraton", basePointRate: 5 },
      { hotelChainId: HOTEL_ID.MARRIOTT, name: "StudioRes by Marriott", basePointRate: 5 },
    ],
  });
  ...
  await prisma.hotelChainSubBrand.createMany({
    data: [
      { hotelChainId: HOTEL_ID.HYATT, name: "Park Hyatt" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Andaz" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Grand Hyatt" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt Regency" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt Centric" },
      { hotelChainId: HOTEL_ID.HYATT, name: "The Unbound Collection by Hyatt" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt Place" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt House" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt Ziva" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Hyatt Zilara" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Thompson Hotels" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Destination by Hyatt" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Alila" },
      { hotelChainId: HOTEL_ID.HYATT, name: "Caption by Hyatt" },
  ...
  await prisma.hotelChainSubBrand.createMany({
    data: [
      { hotelChainId: HOTEL_ID.IHG, name: "InterContinental Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.IHG, name: "Kimpton Hotels & Restaurants" },
      { hotelChainId: HOTEL_ID.IHG, name: "Hotel Indigo" },
      { hotelChainId: HOTEL_ID.IHG, name: "Crowne Plaza Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.IHG, name: "Holiday Inn Hotels & Resorts" },
      { hotelChainId: HOTEL_ID.IHG, name: "Holiday Inn Express" },
      ...
      { hotelChainId: HOTEL_ID.IHG, name: "Voco Hotels" },
      { hotelChainId: HOTEL_ID.IHG, name: "Even Hotels" },
      { hotelChainId: HOTEL_ID.IHG, name: "Avid Hotels" },
    ],
  });
  ...
  await prisma.hotelChainSubBrand.createMany({
    data: [
      { hotelChainId: HOTEL_ID.ACCOR, name: "Raffles" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Banyan Tree" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Fairmont" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Sofitel" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "MGallery" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Pullman" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Swissôtel" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Novotel" },
      { hotelChainId: HOTEL_ID.ACCOR, name: "Mercure" },
