...
describe('PaymentTypeBreakdown', () => {
  ...
  it('handles combination stays correctly', () => {
    ...
    expect(screen.getByText((content, element) => {
      const hasText = (node: Element | null) => node?.textContent?.includes('1 combination booking ignored because nightly breakdown is unavailable');
    ...
    const incidentalBooking = [
      {
        id: 5,
        numNights: 1,
        totalCost: 12.50, // Insignificant cash (< $20)
