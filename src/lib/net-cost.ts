        ...
        while (nightsAccountedFor < nightsInStay) {
          ...
          if (progressInCurrentCycle === 0) {
            if (nightsInThisSegment === minNights) {
              ...
              label = isSegmentUnfulfillable
                ? `Unfulfillable Reward Cycle (${nightsInThisSegment}/${minNights} nights)`
                : `New Reward Cycle (${nightsInThisSegment}/${minNights} nights)`;
              description = isSegmentUnfulfillable
            ...
            if (isCycleFinished) {
              ...
              label = isSegmentUnfulfillable
                ? `Unfulfillable Cycle Progress (${nightsInThisSegment} nights)`
