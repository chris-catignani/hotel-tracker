...
// CRITICAL: IVAN* codes are silently omitted from the response if rates.ratePlanCodes is absent
// from the request body. No error is thrown — award rates simply disappear without warning.
