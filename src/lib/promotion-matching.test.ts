...
describe("spanStays", () => {
  ...
  it("should apply proportional reward for a single stay below min nights", () => {
    ...
    const matched = calculateMatchedPromotions(booking, [promo], usage as any);
    expect(matched).toHaveLength(1);
  ...
  it("should apply multiple rewards across stays spanning increments", () => {
    ...
    const matched1 = calculateMatchedPromotions(booking1, [promo], usage1 as any);
    ...
    const matched2 = calculateMatchedPromotions(booking2, [promo], priorUsage as any);
  ...
  it("should respect benefit-level maxTotalBonusPoints", () => {
    ...
    const matched = calculateMatchedPromotions(booking, [promoLimit], usage as any);
    expect(matched).toHaveLength(1);
  ...
  it("should apply multiple rewards across stays spanning increments (orphaned detection)", () => {
    ...
    const matched = calculateMatchedPromotions(booking, [promoOrphan], usage1 as any);
...
describe("promotion-matching architecture: Core vs Fulfillment", () => {
  ...
  it("should correctly handle tiered prerequisites in the rule-based engine", () => {
    ...
    const match2 = calculateMatchedPromotions(mockBooking, [tieredPromo], priorUsage as any);
